    ...
    <tbody>
      <c:choose>
        <c:when test="${empty myRentalList}">
          <tr>
            <td colspan="5" style="text-align:center; color:#aaa;">대여 중인 비품이 없습니다.</td>
          </tr>
        </c:when>
        <c:otherwise>
          ...
          <tr>
            ...
            <td>
              <div class="btn-group">
                <a href="returnQr.do" class="btn btn-return">반납</a>
                <a href="extendRequest.do" class="btn btn-extend">연장</a>
                <a href="reportIssue.do" class="btn btn-report">신고</a>
              </div>
            </td>
          </tr>
          </c:forEach>
